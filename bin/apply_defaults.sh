...
# Turn down the sound effects on boot
...
# Set a blazingly fast cursor
defaults write "Apple Global Domain" com.apple.mouse.scaling 2.0
...
# Decrease the animation when hiding/showing the Dock
